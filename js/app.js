(() => {
                ...
                var factoryOutput = (() => {
                    ...
                    var Iti = class {
                        ...
                        _processCountryData() {
                            ...
                            if (this.options.onlyCountries.length || this.options.i18n) this.countries.sort(countryNameSort);
                        }
                        ...
                        _generateMarkup() {
                            ...
                            const {allowDropdown, showSelectedDialCode, showFlags, containerClass, hiddenInput, dropdownContainer, fixDropdownWidth, useFullscreenPopup, countrySearch, i18n} = this.options;
                            let parentClass = "iti";
                            ...
                            if (this.selectedCountry && this.telInput.disabled) this.selectedCountry.setAttribute("aria-disabled", "true");
                            if (showSelectedDialCode) this.selectedDialCode = createEl("div", {
                                class: "iti__selected-dial-code"
                            }, this.selectedCountry);
                            if (allowDropdown) {
                                if (!this.telInput.disabled) this.selectedCountry.setAttribute("tabindex", "0");
                        ...
                        _setInitialState(overrideAutoCountry = false) {
                            ...
                            if (dialCode && !isRegionlessNanpNumber) this._updateCountryFromNumber(val); else if (initialCountry !== "auto" || overrideAutoCountry) {
                        ...
                        _initRequests() {
                            if (this.options.utilsScript && !window.intlTelInputUtils) if (window.intlTelInputGlobals.documentReady()) window.intlTelInputGlobals.loadUtils(this.options.utilsScript); else window.addEventListener("load", (() => {
                            ...
                            if (strictMode) {
                                this._handleKeydownEvent = e => {
                                    if (e.key && e.key.length === 1 && !e.altKey && !e.ctrlKey && !e.metaKey) {
                                        ...
                                        if (!isAllowedChar || hasReachedMaxLength) e.preventDefault();
                                    }
                                };
                        ...
                        _setDropdownPosition() {
                            ...
                            if (!this.options.useFullscreenPopup) {
                                ...
                                toggleClass(this.dropdownContent, "iti__dropdown-content--dropup", positionDropdownAboveInput);
                        ...
                        _updateCountryFromNumber(fullNumber) {
                            ...
                            if (this.options.showSelectedDialCode && selectedDialCode && number.charAt(0) !== "+") number = `+${selectedDialCode}${number}`;
                        ...
                        _highlightListItem(listItem, shouldFocus) {
                            ...
                            this.selectedCountry.setAttribute("aria-activedescendant", listItem.getAttribute("id") || "");
                            if (this.options.countrySearch) this.searchInput.setAttribute("aria-activedescendant", listItem.getAttribute("id") || "");
                        ...
                        _setCountry(iso2) {
                            ...
                            if (showSelectedDialCode) {
                                ...
                                if (this.isRTL) this.telInput.style.paddingRight = `${selectedCountryWidth + 6}px`; else this.telInput.style.paddingLeft = `${selectedCountryWidth + 6}px`;
                            }
                        ...
                        _updateMaxLength() {
                            if (this.options.strictMode && window.intlTelInputUtils) if (this.selectedCountryData.iso2) {
                                ...
                                let exampleNumber = window.intlTelInputUtils.getExampleNumber(this.selectedCountryData.iso2, false, numberType, true);
                        ...
                        _setSelectedCountryTitleAttribute(iso2 = null, showSelectedDialCode) {
                            ...
                            let title;
                            if (iso2 && !showSelectedDialCode) title = `${this.selectedCountryData.name}: +${this.selectedCountryData.dialCode}`; else if (iso2) title = this.selectedCountryData.name; else title = "Unknown";
                        ...
                        _updatePlaceholder() {
                            ...
                            if (window.intlTelInputUtils && shouldSetPlaceholder) {
                                ...
                                let placeholder = this.selectedCountryData.iso2 ? window.intlTelInputUtils.getExampleNumber(this.selectedCountryData.iso2, nationalMode, numberType) : "";
                        ...
                        _getFullNumber() {
                            ...
                            if (this.options.showSelectedDialCode && !this.options.nationalMode && val.charAt(0) !== "+" && dialCode && numericVal) prefix = `+${dialCode}`; else prefix = "";
                            return prefix + val;
                        }
                        ...
                        getExtension() {
                            if (window.intlTelInputUtils) return window.intlTelInputUtils.getExtension(this._getFullNumber(), this.selectedCountryData.iso2);
                            return "";
                        }
                        getNumber(format) {
                            if (window.intlTelInputUtils) {
                        ...
                        getNumberType() {
                            if (window.intlTelInputUtils) return window.intlTelInputUtils.getNumberType(this._getFullNumber(), this.selectedCountryData.iso2);
                            return -99;
                        }
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".testmonials__slider")) new swiper_core_Swiper(".testmonials__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            const btnUp = document.querySelector(".go-to-up");
